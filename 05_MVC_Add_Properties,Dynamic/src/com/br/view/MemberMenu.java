...
public class MemberMenu {
	...
	public void mainMenu() {
		...
		while(true) {
			...
			case 6: mc.deleteMember(inputMemberId()); 
					break;    
			case 7: mc.memberLogin(inputMemberId(), inputMemberPwd()); break;
	...
	public void displayMyPage(Member m) {
		System.out.println("\n===== 마이페이지 =====");
		System.out.println("* 이름 : " + m.getUserName());
		System.out.println("* 이메일 : " + (m.getEmail() == null ? "없음" : m.getEmail()));
		System.out.println("* 전화번호 : " + (m.getPhone() == null ? "없음" : m.getPhone()));
		System.out.println("* 주소 : " + (m.getAddress() == null ? "없음": m.getAddress()));
		...
		if(m.getHobby() == null) {
			...
			/*
			StringTokenizer stn = new StringTokenizer(m.getHobby(), ",");
